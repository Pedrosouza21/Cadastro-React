...
{
    const exiibriAcoes = props.clienteExcluido || props.clienteSelecionado
        ...
        return (
            <tr> 
                ...
                <th className="text-left p-4"> Idade</th>
                 {exiibriAcoes ? <th className=" p-4"> Açoes</th> : false }
            </tr>
        ...
        return props.clientes?.map((cliente, i) => {
             return (
                ...
                className={`${i % 2 === 0 ? 'bg-purple-200 ' : 'bg-purple-100'
                    ...
                    {exiibriAcoes ? renderizarAcoes(cliente): false}
                </tr>
             )
        })
    }
